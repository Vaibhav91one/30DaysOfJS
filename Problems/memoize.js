//Memoize is the technique where the first result is cached in an object or map and for every other function call the cache is checked of the solution if present, else computation is done.
